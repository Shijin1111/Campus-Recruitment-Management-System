...
from .models import stu_details  # Import the stu_details model
from .forms import Student_SignUpForm
...
#             # Save additional student details to the stu_details model
...
#                 cgpa_Btech=form.cleaned_data.get('cgpa_Btech'),
#                 class_10_cgpa=form.cleaned_data.get('class_10_cgpa'),
#                 class_12_percentage=form.cleaned_data.get('class_12_percentage'),
#                 certifications_count=form.cleaned_data.get('certifications_count'),
#                 internship=form.cleaned_data.get('internship'),
#                 languages=form.cleaned_data.get('languages'),
#                 sop=form.cleaned_data.get('sop'),
...
#         else:
#             # If the form is not valid, re-render the registration page with the form errors
#             return render(request, 'campus/register.html', {'form': form})
#     else:
#         # For GET requests, instantiate an empty form and display the registration page
...
from django.shortcuts import render, redirect
from django.contrib.auth.models import Group
from .forms import Student_SignUpForm  # Assuming Student_SignUpForm is in forms.py
...
def student_register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Create stu_details instance and save related data
            stu_details_data = stu_details()
            stu_details_data.username = form.cleaned_data['username']
            stu_details_data.name = form.cleaned_data['first_name'] + ' ' + form.cleaned_data['last_name']
            stu_details_data.phone_number = form.cleaned_data['phone_number']
            stu_details_data.fathers_name = form.cleaned_data['fathers_name']
            stu_details_data.mothers_name = form.cleaned_data['mothers_name']
            stu_details_data.gender = form.cleaned_data['gender']
            stu_details_data.place = form.cleaned_data['place']
            stu_details_data.branch = form.cleaned_data['branch']
            stu_details_data.cgpa_Btech = form.cleaned_data['cgpa_Btech']
            stu_details_data.class_10_cgpa = form.cleaned_data['class_10_cgpa']
            stu_details_data.class_12_percentage = form.cleaned_data['class_12_percentage']
            stu_details_data.certifications_count = form.cleaned_data['certifications_count']
            stu_details_data.internship = form.cleaned_data['internship']
            stu_details_data.languages = form.cleaned_data['languages']
            stu_details_data.sop = form.cleaned_data['sop']
            stu_details_data.dob = form.cleaned_data['dob']
            stu_details_data.email = form.cleaned_data['email']

            stu_details_data.save()  # Save stu_details to the database
