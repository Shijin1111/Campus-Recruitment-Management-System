...
class stu_details(models.Model):
    ...
    gender = models.CharField(max_length=10, choices=GENDER_CHOICES, help_text="*required")
    branch = models.CharField(max_length=10, choices=BRANCH_CHOICES, help_text="*required")
